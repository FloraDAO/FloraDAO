  ...
  <v-app :style="{ background: $vuetify.theme.themes[theme].background }">
    ...
    >
      <div class="d-flex align-center">
        ...
        <v-app-bar-title v-if="!isMobile" class="font-weight-bold text-h5 head"
          >FloraDAO</v-app-bar-title
        >
      </div>
      ...
      <div v-if="!isMobile" class="d-flex justify-space-around">
        ...
        <v-btn
          :href="`${publicPath}FloraDAO_Whitepaper.pdf`"
          download="FloraDAO_Whitepaper"
          plain
          text
          :ripple="false"
        >
    ...
    <v-footer color="#0E0E12" padless>
      <v-container>
        <v-row>
          ...
          >
            <v-img
              src="@/assets/img/floradao.jpeg"
              class="shrink mr-2 br-15"
              width="80"
              contain
            ></v-img>
          </v-col>
    ...
    <v-overlay :opacity="opacity" :value="overlay">
      <v-icon
        ...
        size="1.5x"
        class="custom-class"
        style="position: fixed; top: 2%; right: 1.5em;"
        >mdi-close</v-icon
      >
      <v-row class="text-center">
        <v-col cols="12">
          <v-btn href="/" text plain :ripple="false">
            <span class="font-weight-light text-capitalize white--text"
              >Home</span
            >
          </v-btn>
        </v-col>
        ...
        <v-col cols="12">
          <v-btn
            href="https://t.me/joinchat/8bR3KMe3JAI4Yzg0"
            target="_blank"
            color="#FFB39C"
            outlined
            rounded
...
export default {
  ...
  data: () => ({
    ...
    socials: [
      ...
      {
        name: "Twitter",
        url: "https://twitter.com/FloraDA0?s=09",
      },
      {
        name: "Telegram",
      ...
      {
        name: "Instagram",
        url: "https://www.instagram.com/florada0?r=nametag",
      },
      {
        name: "Github",
